...
class Butter extends Decorator {
    ...
    @Override
    String getDescription() {
        return this.bread.getDescription() + ", Butter";
    }

    @Override
    int getKcal() {
        return this.bread.getKcal() + 50;
    }
}
...
class Jam extends Decorator {
    ...
    @Override
    String getDescription() {
        return this.bread.getDescription() + ", Jam";
    }

    @Override
    int getKcal() {
        return this.bread.getKcal() + 120;
    }
}
...
class Ham extends Decorator {
    ...
    @Override
    String getDescription() {
        return this.bread.getDescription() + ", Ham";
    }

    @Override
    int getKcal() {
        return this.bread.getKcal() + 2500;
    }
}